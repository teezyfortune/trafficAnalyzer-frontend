  ...
  return (
    <div>
		...
		<strong>location</strong>: {data && data.location}
			...
			<li className="list" style={{ listStyle: "none" }}>
			<strong>Traffic Type</strong> : {data && data.trafficType}
			</li>
			<li className="list" style={{ listStyle: "none" }}>
			<strong>Longitude</strong> : {data && data.longitude}
			</li>
			<li className="list" style={{ listStyle: "none" }}>
			<strong>Latitude</strong> : {data && data.latitude}
			</li>
			<li className="list" style={{ listStyle: "none" }}>
			<strong>congestion Details</strong> : {data && data.congestionDetails}
			</li>
			<li className="list" style={{ listStyle: "none" }}>
